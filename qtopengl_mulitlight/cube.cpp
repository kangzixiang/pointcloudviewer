...
void Cube::initCube() {
  // back
  vertices << QVector3D(-0.5, -0.5, -0.5f) << QVector3D(0.5, -0.5, -0.5f)
           << QVector3D(0.5, 0.5, -0.5f) << QVector3D(0.5, 0.5, -0.5f)
           << QVector3D(-0.5, 0.5, -0.5f) << QVector3D(-0.5, -0.5, -0.5f);

  normals << QVector3D(0.0f, 0.0f, -1.0f) << QVector3D(0.0f, 0.0f, -1.0f)
          << QVector3D(0.0f, 0.0f, -1.0f) << QVector3D(0.0f, 0.0f, -1.0f)
          << QVector3D(0.0f, 0.0f, -1.0f) << QVector3D(0.0f, 0.0f, -1.0f);

  coords << QVector2D(0, 0) << QVector2D(1, 0) << QVector2D(1, 1)
  ...
  normals << QVector3D(-1.0f, 0.0f, 0.0f) << QVector3D(-1.0f, 0.0f, 0.0f)
          << QVector3D(-1.0f, 0.0f, 0.0f) << QVector3D(-1.0f, 0.0f, 0.0f)
          << QVector3D(-1.0f, 0.0f, 0.0f) << QVector3D(-1.0f, 0.0f, 0.0f);

  coords << QVector2D(1, 0) << QVector2D(1, 1) << QVector2D(0, 1)
  ...
  normals << QVector3D(0.0f, -1.0f, 0.0f) << QVector3D(0.0f, -1.0f, 0.0f)
          << QVector3D(0.0f, -1.0f, 0.0f) << QVector3D(0.0f, -1.0f, 0.0f)
          << QVector3D(0.0f, -1.0f, 0.0f) << QVector3D(0.0f, -1.0f, 0.0f);

  coords << QVector2D(0, 1) << QVector2D(1, 1) << QVector2D(1, 0)
         << QVector2D(1, 0) << QVector2D(0, 0) << QVector2D(0, 1);
