...
GLWindow::GLWindow(QOpenGLContext *shareContext,
...
void GLWindow::updateFPS(qreal v) { mFps = v; }

void GLWindow::timerEvent(QTimerEvent *) { update(); }
#ifdef GL_DEBUG
